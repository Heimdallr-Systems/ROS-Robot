                  ...
                  rc_FR[3], double rc_FL[3], double rc_BR[3], double rc_BL[3])
  {
    ...
    for (int i5 = 0; i5 < 3; i5++) {
      ...
      for (int i8 = 0; i8 < 3; i8++) {
        T2_FL[i5 + (3 * i8)] = ((d9 * b_dv[3 * i8]) + (d10 * b_dv[(3 * i8) + 1]))
          + (d11 * b_dv[(3 * i8) + 2]);
      }
    }
    ...
    for (int i7 = 0; i7 < 3; i7++) {
      ...
      for (int i10 = 0; i10 < 3; i10++) {
        T1_BR[i7 + (3 * i10)] = ((d12 * b_dv[3 * i10]) + (d13 * b_dv[(3 * i10) +
          1])) + (d14 * b_dv[(3 * i10) + 2]);
      }
    }
    ...
    for (int i9 = 0; i9 < 3; i9++) {
      ...
      for (int i12 = 0; i12 < 3; i12++) {
        T2_BR[i9 + (3 * i12)] = ((d15 * b_dv[3 * i12]) + (d16 * b_dv[(3 * i12) +
          1])) + (d17 * b_dv[(3 * i12) + 2]);
      }
    }
    ...
    for (int i11 = 0; i11 < 3; i11++) {
      ...
      for (int i14 = 0; i14 < 3; i14++) {
        T1_BL[i11 + (3 * i14)] = ((d18 * b_dv[3 * i14]) + (d19 * b_dv[(3 * i14)
          + 1])) + (d20 * b_dv[(3 * i14) + 2]);
      }
    }
    ...
    for (int i13 = 0; i13 < 3; i13++) {
      ...
      for (int i15 = 0; i15 < 3; i15++) {
        T2_BL[i13 + (3 * i15)] = ((d21 * b_dv[3 * i15]) + (d22 * b_dv[(3 * i15)
          + 1])) + (d23 * b_dv[(3 * i15) + 2]);
      }
    }
    ...
    for (int i16 = 0; i16 < 3; i16++) {
      ...
      for (int i18 = 0; i18 < 3; i18++) {
        ...
        d29 += (((T2_FR[i16] * b_dv[3 * i18]) + (T2_FR[i16 + 3] * b_dv[(3 * i18)
                  + 1])) + (T2_FR[i16 + 6] * b_dv[(3 * i18) + 2])) * dv3[i18];
        d26 += d35 * dv4[i18];
      }
    ...
    for (int i17 = 0; i17 < 3; i17++) {
      ...
      for (int i21 = 0; i21 < 3; i21++) {
        ...
        d32 += (((T2_FL[i17] * b_dv[3 * i21]) + (T2_FL[i17 + 3] * b_dv[(3 * i21)
                  + 1])) + (T2_FL[i17 + 6] * b_dv[(3 * i21) + 2])) * dv7[i21];
    ...
    for (int i19 = 0; i19 < 3; i19++) {
      ...
      for (int i23 = 0; i23 < 3; i23++) {
        ...
        d39 += (((T2_BR[i19] * b_dv[3 * i23]) + (T2_BR[i19 + 3] * b_dv[(3 * i23)
                  + 1])) + (T2_BR[i19 + 6] * b_dv[(3 * i23) + 2])) * dv3[i23];
    ...
    for (int i22 = 0; i22 < 3; i22++) {
      ...
      for (int i24 = 0; i24 < 3; i24++) {
        ...
        d41 += (((T2_BL[i22] * b_dv[3 * i24]) + (T2_BL[i22 + 3] * b_dv[(3 * i24)
                  + 1])) + (T2_BL[i22 + 6] * b_dv[(3 * i24) + 2])) * dv7[i24];
      }
