                    ...
                    double JN[108], double dotJN[108])
  {
    ...
    for (int i = 0; i < 3; i++) {
      ...
      for (int i3 = 0; i3 < 3; i3++) {
        ITN[i + (3 * i3)] = ((d * nTN[3 * i3]) + (d1 * nTN[(3 * i3) + 1])) + (d2
          * nTN[(3 * i3) + 2]);
      }
    }
    ...
    for (int i2 = 0; i2 < 3; i2++) {
      ...
      for (int i6 = 0; i6 < 3; i6++) {
        ...
        d8 = nTN[i9];
        d_a_tmp[i6 + (3 * i2)] = d8;
        c_a_tmp[i9] = ((d3 * JN_tmp_tmp[3 * i6]) + (d4 * JN_tmp_tmp[(3 * i6) + 1]))
    ...
    for (int i7 = 0; i7 < 3; i7++) {
      ...
      for (int i13 = 0; i13 < 18; i13++) {
        b_y[i7 + (3 * i13)] = y[(i7 + (6 * i13)) + 3] + (((d6 * IN_tilde[3 * i13])
          + (d9 * IN_tilde[(3 * i13) + 1])) + (d10 * IN_tilde[(3 * i13) + 2]));
      }
    }
    ...
    for (int i15 = 0; i15 < 3; i15++) {
      ...
      for (int i25 = 0; i25 < 3; i25++) {
        ...
        i29 = (3 * i25) + 2;
        i32 = i15 + (3 * i25);
        b_dv3[i32] = ((d16 * d_a_tmp[3 * i25]) + (d17 * d_a_tmp[i27])) + (d20 *
          d_a_tmp[i29]);
        b_dotJN_tmp[i32] = (((d22 * JN_tmp_tmp[3 * i25]) + (d24 * JN_tmp_tmp[i27]))
                            + (d25 * JN_tmp_tmp[i29])) + b_dv1[i32];
      }
    }
    ...
    for (int i17 = 0; i17 < 3; i17++) {
      ...
      for (int i22 = 0; i22 < 3; i22++) {
        c_a_tmp[i17 + (3 * i22)] = ((d19 * b_dotJN_tmp[3 * i22]) + (d21 *
          b_dotJN_tmp[(3 * i22) + 1])) + (d23 * b_dotJN_tmp[(3 * i22) + 2]);
    ...
    for (int i20 = 0; i20 < 3; i20++) {
      ...
      for (int i28 = 0; i28 < 3; i28++) {
        c_a_tmp[i20 + (3 * i28)] = ((d26 * JN_tmp_tmp[3 * i28]) + (d27 *
          JN_tmp_tmp[(3 * i28) + 1])) + (d28 * JN_tmp_tmp[(3 * i28) + 2]);
    ...
    for (int i30 = 0; i30 < 3; i30++) {
      ...
      for (int i36 = 0; i36 < 3; i36++) {
        c_ITn[i30 + (3 * i36)] = ((d29 * dotJN_tmp[3 * i36]) + (d31 * dotJN_tmp
          [(3 * i36) + 1])) + (d33 * dotJN_tmp[(3 * i36) + 2]);
      }
      ...
      for (int i39 = 0; i39 < 18; i39++) {
        b_ITn[i30 + (3 * i39)] = ((d34 * IN_tilde[3 * i39]) + (d35 * IN_tilde[(3
          * i39) + 1])) + (d36 * IN_tilde[(3 * i39) + 2]);
      }
    }
